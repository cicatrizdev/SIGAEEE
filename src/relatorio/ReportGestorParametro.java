...
// * @author PeeP
// */
//public class ReportGestorParametro extends HttpServlet {
//
...
//            parametros.put("PAR_Nome", request.getParameter("paramGestor"));
//            String relatorio = getServletContext().getRealPath("/WEB-INF/classes/relatorio") + "/ReportGestorParam.jasper";
