...
// * @author PeeP
// */
//public class ReportEquipeParametro extends HttpServlet {
//
...
//            parametros.put("PAR_Nome", request.getParameter("paramEquipe"));
//            String relatorio = getServletContext().getRealPath("/WEB-INF/classes/relatorio") + "/ReportEquipeParam.jasper";
