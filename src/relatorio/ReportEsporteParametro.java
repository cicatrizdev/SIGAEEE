...
// * @author PeeP
// */
//public class ReportEsporteParametro extends HttpServlet {
//
...
//            parametros.put("PAR_Nome", request.getParameter("paramEsporte"));
//            String relatorio = getServletContext().getRealPath("/WEB-INF/classes/relatorio") + "/ReportEsporteParam.jasper";
