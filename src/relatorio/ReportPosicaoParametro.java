...
// * @author PeeP
// */
//public class ReportPosicaoParametro extends HttpServlet {
//
...
//            parametros.put("PAR_Nome", request.getParameter("paramPosicao"));
//            String relatorio = getServletContext().getRealPath("/WEB-INF/classes/relatorio") + "/ReportPosicaoParam.jasper";
