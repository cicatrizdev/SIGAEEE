...
// * @author PeeP
// */
//public class ReportTipoEventoParametro extends HttpServlet {
//
...
//            parametros.put("PAR_Nome", request.getParameter("paramTipoEvento"));
//            String relatorio = getServletContext().getRealPath("/WEB-INF/classes/relatorio") + "/ReportTipoEventoParam.jasper";
