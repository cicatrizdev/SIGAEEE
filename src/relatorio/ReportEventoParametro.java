...
// * @author PeeP
// */
//public class ReportEventoParametro extends HttpServlet {
//
...
//            parametros.put("PAR_Nome", request.getParameter("paramEvento"));
//            String relatorio = getServletContext().getRealPath("/WEB-INF/classes/relatorio") + "/ReportEventoParam.jasper";
