...
<table>
    ...
    <c:forEach items="${gestores}" var="gestor">
        <tr>
            <td><c:out value="${gestor.getId()}"/></td>
            <td><c:out value="${gestor.getNome()}" /></td>
            <td><a href="ManterGestorController?acao=prepararOperacao&operacao=Editar&idGestor=<c:out value="${gestor.getId()}"/>">Editar</a></td>
            <td><a href="ManterGestorController?acao=prepararOperacao&operacao=Excluir&idGestor=<c:out value="${gestor.getId()}"/>">Excluir</a></td>
        </tr>
    </c:forEach >
</table>
